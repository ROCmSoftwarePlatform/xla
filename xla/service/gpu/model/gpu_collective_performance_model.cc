...
GpuPerformanceWithCollectiveModel::ComputeAllreduceTime(
  ...
  stream_executor::RocmComputeCapability compute_cap =
      gpu_device_info.rocm_compute_capability();
#endif
  ...
  //   speed_index++;
  // }
  float bw_intra_node = 32; //speeds[speed_index];

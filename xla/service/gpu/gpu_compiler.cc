...
Status GpuCompiler::OptimizeHloModule(HloModule* hlo_module,
  ...
  AlgebraicSimplifierOptions layout_insensitive_algsimp_opts({},
                                                             ConvIsLowerable);
  VLOG(5) << "Zoran: OptimizeHloModule 0";
  ...
  VLOG(5) << "Zoran: OptimizeHloModule 1";
  ...
  if (num_partitions > 1) {
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 2";
#ifdef PLATFORM_GOOGLE
    VLOG(5) << "Zoran: OptimizeHloModule 3";
    if (auto_sharding) {
...
#endif  // PLATFORM_GOOGLE
    VLOG(5) << "Zoran: OptimizeHloModule 4";
  ...
  {
    VLOG(5) << "Zoran: OptimizeHloModule 5";
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 6";
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 7";
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 8";
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 10";
    ...
    [&, &pipeline =
      ...
      pipeline.AddPass<ZeroSizedHloElimination>();
      VLOG(5) << "Zoran: OptimizeHloModule 11";
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 12";
  ...
  {
    VLOG(5) << "Zoran: OptimizeHloModule 13";
    ...
    if (debug_options.xla_gpu_enable_pipelined_all_reduce()) {
      VLOG(5) << "Zoran: OptimizeHloModule 14";
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 15";
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 16";
  ...
  VLOG(5) << "Zoran: OptimizeHloModule 17";
  ...
  VLOG(5) << "Zoran: OptimizeHloModule 18";
...

  {
    ...
    VLOG(5) << "Zoran: OptimizeHloModule 19";
  ...
  VLOG(5) << "Zoran: OptimizeHloModule 20";
  ...
  VLOG(5) << "Zoran: OptimizeHloModule 21";
  {
...
Status GpuCompiler::OptimizeHloPostLayoutAssignment(
  ...
  {
    VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 0 ";
    HloPassPipeline pipeline("hlo normalization");

    pipeline.AddPass<DotDimensionMerger>();
    VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 1 ";
    ...
    VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 2 ";
    // "slow" minmax means we propagate nan.
    ...
    VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 3 ";
    pipeline.AddPass<TransposeFolding>(CanFoldTransposeOperandIntoDot,
    ...
    VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 4";
    ...
    if (debug_options.xla_gpu_enable_triton_gemm() &&
      ...
      VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 5 ";
      if (cuda_compute_capability.IsAtLeast(se::CudaComputeCapability::VOLTA)) {
        ...
        std::holds_alternative<se::RocmComputeCapability>(
            gpu_target_config.gpu_version)) {
              VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 5a ";
              pipeline.AddPass<GemmRewriterTriton>(gpu_target_config.gpu_version);
    }

    VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 6 ";
    pipeline.AddPass<GemmRewriter>(gpu_target_config.gpu_version);

    // Rewrite GEMMs with broadcasted inputs as strided GEMMs.
    pipeline.AddPass<GemmBroadcastFoldingRewriter>();
    VLOG(5) << "Zoran: OptimizeHloPostLayoutAssignment 7 ";

...
TEST_F(MlirConcatenateFusionTest, StandAloneConcatenate) {
  ...
  TF_ASSERT_OK(EmitAndCheckIR(kHloString, R"(
    // CHECK-DAG: #[[MAP_1:.*]] = affine_map<(d0, d1) -> ((d1 * 256 + d0) mod 400)>
    // CHECK-DAG: #[[MAP_2:.*]] = affine_map<(d0, d1) -> ((d1 * 256 + d0) mod 400 + 200)>
    // CHECK-DAG: #[[MAP_3:.*]] = affine_map<(d0, d1) -> ((d1 * 256 + d0) mod 400 + 600)>

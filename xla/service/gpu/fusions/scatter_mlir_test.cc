...
TEST_F(MlirScatterFusionTest, ThreadIdIndexing) {
  ...
  constexpr auto kUpdatesIndexing = R"(
    ...
    ((bl_x * 32 + th_x floordiv 8) floordiv 25) mod 42,
    ((bl_x * 64 + th_x floordiv 4) floordiv 5) mod 10,
  ...
  constexpr auto kIndicesIndexing = R"(
    ...
    ((bl_x * 32 + th_x floordiv 8) floordiv 25) mod 42, 0)
    domain:
    th_x in [0, 255]
    th_y in [0, 0]
    th_z in [0, 0]

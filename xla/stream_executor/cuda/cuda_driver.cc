...
/* static */ absl::Status GpuDriver::GraphGetMemsetNodeParams(
  ...
  RETURN_IF_ROCM_ERROR(cuGraphMemsetNodeGetParams(node, pNodeParams),
...
/* static */ absl::Status GpuDriver::GraphAddMemsetNode(
    ...
    absl::Span<const CUgraphNode> deps, const GpuGraphMemsetNodeParams& params) {
...
/* static */ absl::Status GpuDriver::GraphExecMemsetNodeSetParams(
    GpuContext* context, CUgraphExec exec, CUgraphNode node, 
